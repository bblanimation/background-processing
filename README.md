...
* Write your own background processing scripts
    ...
    * Background processing scripts should include a `data_blocks` variable
        ...
        * these data blocks can be accessed with the `JobManager.get_retrieved_data_blocks` API call.
            * NOTE: `dir(JobManager.get_retrieved_data_blocks(job)) = ['actions', 'armatures', 'brushes', 'cache_files', 'cameras', 'curves', 'fonts', 'grease_pencil', 'groups', 'images', 'ipos', 'lamps', 'lattices', 'linestyles', 'masks', 'materials', 'meshes', 'metaballs', 'movieclips', 'node_groups', 'objects', 'paint_curves', 'palettes', 'particles', 'scenes', 'sounds', 'speakers', 'texts', 'textures', 'worlds']`
    ...
    * Background processing scripts should include a `python_data` variable
        ...
        * The background processor will automatically copy this dictionary to the active instance of Blender upon job completion
